...
export const playgroundTabs = [
  {
    id: "aws",
    label: "AWS",
    nodes: ["Internet", "Route53", "ALB", "EC2 / EKS", "Database / Storage"],
  },
  {
    id: "azure",
    label: "AZURE",
    nodes: ["Internet", "Application Gateway", "AKS", "ACR", "Application"],
  },
  {
    id: "kubernetes",
    label: "KUBERNETES",
    nodes: ["Ingress", "Service", "Deployment", "Pods"],
  },
  {
    id: "terraform",
    label: "TERRAFORM",
    nodes: ["Terraform", "Modules", "Resources", "AWS / Azure / GCP"],
  },
  {
    id: "cicd",
    label: "CI/CD",
    nodes: ["GitHub", "GitHub Actions", "Build", "Docker", "Registry", "Deploy"],
  },
] as const;
...
export const architectureFlow = [
  ...
  { id: "dns", label: "DNS / CDN", x: 50, y: 18, connections: ["lb"] },
  { id: "lb", label: "LOAD BALANCER", x: 50, y: 32, connections: ["app"] },
  { id: "app", label: "APPLICATION", x: 50, y: 46, connections: ["db", "storage", "queue"] },
  { id: "db", label: "DATABASE", x: 25, y: 62, connections: ["observability"] },
  { id: "storage", label: "STORAGE", x: 50, y: 62, connections: ["observability"] },
  { id: "queue", label: "QUEUE", x: 75, y: 62, connections: ["observability"] },
  { id: "observability", label: "OBSERVABILITY", x: 25, y: 78, connections: ["metrics", "logs", "traces"] },
  { id: "metrics", label: "Metrics", x: 10, y: 92, connections: [] },
  { id: "logs", label: "Logs", x: 25, y: 92, connections: [] },
  { id: "traces", label: "Traces", x: 40, y: 92, connections: [] },
] as const;
